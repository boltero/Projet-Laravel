  ...
  <body>
    ...
    <form action="/modifier/traitement" method="POST">
        ...
        <div class="mb-3">
          ...
          <input type="text" class="form-control" id="nom" name="nom" value="{{ $etudiants ->nom}}" aria-describedby="nom" >
          
        </div>
        <div class="mb-3">
          <label for="prenom" class="form-label">PRENOM</label>
          <input type="text" class="form-control" id="prenom" name="prenom" value="{{ $etudiants ->prenom}}" aria-describedby="prenom">
          
        </div>
        <div class="mb-3">
          <label for="classe" class="form-label">CLASSE</label>
          <input type="text" class="form-control" id="classe" name="classe" value="{{ $etudiants ->classe}}" aria-describedby="classe">
